...
func (s *Server) RegisterRoutes() http.Handler {
	...
	formHandler := handlers.NewFormHandler(s.platformDB)
	...
	{
		jobsHandler := handlers.NewJobsHandler(s.jobClient, s.db.GetPool())
		adminGroup.POST("/jobs/orphan-scan", jobsHandler.TriggerOrphanScan)
		adminGroup.GET("/jobs/orphan-scan", jobsHandler.GetOrphanScanResults)
		adminGroup.GET("/jobs/orphan-scan/:jobId/files", jobsHandler.GetOrphanFiles)
	}
