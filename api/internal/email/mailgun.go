...
func (ec *EmailClient) SendSubmissionNotification(
	...
	htmlBody := ec.buildNotificationHTMLWithLogo(data, logoURL)
...
func (ec *EmailClient) BuildNotificationHTML(data *SubmissionNotificationData) string {
	logoURL := ec.getLogoURL(data.SpaceLogo, data.SubscriptionTier)
	return ec.buildNotificationHTMLWithLogo(data, logoURL)
}

// buildNotificationHTMLWithLogo creates the HTML email body with a specific logo
func (ec *EmailClient) buildNotificationHTMLWithLogo(data *SubmissionNotificationData, logoURL string) string {
