<script lang="ts">
	...
	let { mobileOpen, onToggleMobile, impersonating = false }: Props = $props();
...
<header class="fixed left-0 right-0 z-50 h-16 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 {impersonating ? 'top-10' : 'top-0'}">
